        ...
        <div class="container">
            ...
            <div class="row g-4 d-flex align-items-center">
               ...
               <div class="col-lg-7 mx-auto">
                 ...
                 <p>
                        Social and community participation refers to the active involvement of individuals within their communities and broader society. It can include things like volunteering, attending community events, joining clubs or organisations, taking part in classes, and building everyday connections with others.
                    </p>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6">
                <div class="why-card">
                    <div class="why-icon">
                       <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:229:6" data-component-name="Icon"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><path d="M16 3.128a4 4 0 0 1 0 7.744"></path><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><circle cx="9" cy="7" r="4"></circle></svg>
                    </div>
                    <h4>Belonging</h4>
                    <p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="why-card">
                    <div class="why-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:229:6" data-component-name="Icon"><path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5"></path></svg>
                    </div>
                    <h4>Connection</h4>
                    <p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="why-card">
                    <div class="why-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sparkles" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:229:6" data-component-name="Icon"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg>
                    </div>
                    <h4>Inclusivity</h4>
                    <p>
...
<section class="case-section">
    <div class="bg_image-project-two">
        <div class="container text-white text-center">
            ...
            <p class="text-white">Life skills are best learned where you’ll actually use them: in the community, at home, and in day-to-day activities.</p>
        </div>
    </div>
  ...
  <div class="container">
    <div class="text-center mb-5">
      ...
      <p class="lead">Below are examples of activities we can support (based on your goals, preferences, and support needs):</p>
    </div>
  ...
  <div class="cta-activity-card h-100 d-flex flex-column position-relative overflow-hidden">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="sparkles-svg opacity-25" aria-hidden="true">
    ...
    <div class="activity-card-body d-flex flex-column justify-content-center align-items-center text-center p-4 z-1">
      <h3 class="text-white">Want something different?</h3>
      <p class="mb-3 text-white">We also create custom activities and support special occasions like concerts, theme parks, and holidays.</p>
 ...
 <section class="custom-hero-section">
    <div class="container">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-ticket text-accent" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:394:18" data-component-name="item.icon"><path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"></path><path d="M13 5v2"></path><path d="M13 17v2"></path><path d="M13 11v2"></path></svg>
      Theme Parks & Zoos
    </div>
            </div>
            <div class="col-6">
              <div class="activity-button">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-music text-accent" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:394:18" data-component-name="item.icon"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>
                Music & Concerts
              </div>
            </div>
            <div class="col-6">
              <div class="activity-button">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-compass text-accent" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:394:18" data-component-name="item.icon"><path d="m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z"></path><circle cx="12" cy="12" r="10"></circle></svg>
                Fishing & Camping
              </div>
            </div>
            <div class="col-6">
              <div class="activity-button">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin text-accent" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:394:18" data-component-name="item.icon"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg>
                Holidays & Getaways
              </div>
            </div>
          </div>
  ...
  <div class="container section">
    ...
    <div class="col-lg-6">
        <img src="{{ asset('assets/images/skills/gateway.png') }}" 
             alt="Person in wheelchair enjoying beach with palm trees"
             class="hero-image">
      </div>
      <!-- Text Content Column -->
      <div class="col-lg-6">
        <div class="content-card">
          ...
          <p>
            Everyone deserves a break. If you or a family member has a disability, Continuity Care can help coordinate supports for a range of options:
          </p>

          <!-- List Items -->
          <div class="feature-item">
            <span class="feature-icons"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-coffee" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:349:22" data-component-name="item.icon"><path d="M10 2v2"></path><path d="M14 2v2"></path><path d="M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1"></path><path d="M6 2v2"></path></svg></span>
            <span class="feature-text">Respite</span>
          </div>

          <div class="feature-item">
            <span class="feature-icons"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shield-check" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:349:22" data-component-name="item.icon"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12 2 2 4-4"></path></svg></span>
            <span class="feature-text">Short-term Accommodation (STA)</span>
          </div>

          <div class="feature-item">
            <span class="feature-icons"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plane" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:349:22" data-component-name="item.icon"><path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"></path></svg></span>
            <span class="feature-text">Holiday or Weekend Getaway</span>
          </div>

          <p>
            We guide you through the planning process and coordinate what's needed to support goals and comfort—so the experience feels organised, supported, and enjoyable.
          </p>

          <div class="note">
            <em>Note: funding for travel-related supports can vary depending on your plan and goals. We’ll help you understand what options may apply.</em>
          </div>
        </div>
      </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-lg-6">
        <div class="left-content">
          ...
          <p>
            Explore Community Participation may be funded through your NDIS plan when it aligns with your goals and support needs. Funding depends on your plan budgets, plan management type, and whether the support is considered appropriate for your situation.
          </p>
      ...
      <div class="col-lg-6">
         <div class="accordion faq-wrapper" id="accordionExample" data-cues="slideInUp" data-duration="900">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>Explore Community Participation may be funded through your NDIS plan when it aligns with your goals and support needs. Funding depends on your plan budgets, plan management type, and whether the support is considered appropriate for your situation.</p>
                   ...
                   <p>If you’re unsure what your plan includes, we can help you understand how Explore may fit with your goals and budgets, and work alongside your Support Coordinator or Plan Manager where needed.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                   ...
                   <p>If you’re not eligible for the NDIS, you can still access supports through self-funded or fee-for-service options.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>Your plan management type can affect how supports are priced and paid:</p>
                                           <ul class="list-unstyled approach-list">
                   <li><span></span> NDIA-managed or plan-managed: providers follow NDIS pricing arrangements and price limits</li>
                   <li><span></span> Self-managed: you generally have more flexibility in provider choice and how supports are paid</li>

                  
                   </ul>
                   <p>If you don’t know how your plan is managed, we can talk you through it and explain the easiest way to get started.</p>
                                    </div>
                                </div>
                            </div>
...
<div class="container">
    ...
    <p class="text-center">
      We offer flexible self-funded and fee-for-service options for those who want quick access to supports or have specific goal-focused needs.
    </p>
    <div class="row">
        <div class="col-lg-6">
<!-- Left Card: Self-Funded -->
      ...
      <div class="card-funded right">
        <div class="card-headers">
          <div class="card-icon"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-no-axes-column-increasing" aria-hidden="true" data-replit-metadata="client/src/pages/home.tsx:762:24" data-component-name="BarChart"><path d="M5 21v-6"></path><path d="M12 21V9"></path><path d="M19 21V3"></path></svg></div>
        </div>
