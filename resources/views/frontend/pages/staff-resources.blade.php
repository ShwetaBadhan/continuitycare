...
@section("content")
        ...
        <div class="faq-area-four ptb-120">
            <div class="container mw-1685">
                ...
                <div class="row g-4">
                 <h2 class="main-titles">Continuity Care Policies</h2></div>
                    <div class="col-lg-12">
                        <div class="accordion faq-wrapper" id="accordionExample" data-cues="slideInUp" data-duration="900">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>You can view our <a href="">click here.</a></p>
                                        <p>If you would like to learn about our Website Terms of Use please  <a href="">click here.</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                     <div class="accordion-body">
                                        <p><a href="">Continuity Whistleblower Policy</a></p>
                                        <p>To make a Whistleblower Disclosure,  <a href="">please complete this form.</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p> <a href="">Continuity Human Rights Policy</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree5" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                     <div class="accordion-body">
                                        <p><a href="">Continuity Feedback & Complaints Policy</a></p>
                                        <p> <a href="">Continuity Feedback & Complaints Policy Easy English version</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree6" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p><a href="">Continuity Risk Management Summary</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
