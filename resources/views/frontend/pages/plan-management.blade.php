...
<!-- Hero Section -->
    <section class="home-care-section">
        <div class="container position-relative">
            ...
            <p class="px-4 text-white">At Continuity Care  we seek to put you in control and give you the flexibility you need to get the most out of your plan. You make the decisions we’ll handle the rest.</p>
            <div class="tagline">
...
<!-- Start Work Area -->
    <div class="work-area pt-120 mb-5">
        <div class="container">
            <div class="row gy-2" data-cues="slideInUp" data-duration="900">
               
                <div class="col-lg-12">
                    <h2 class="main-titles mb-5 ms-auto text-center">Why Choose NDSP?
                        </h2>
                    <p class="mb-5 ms-auto text-center">At NDSP, we're dedicated to providing you with the tools and support needed to effectively manage your services and budget. Enjoy the benefits of having a passionate team of NDIS experts, prompt invoice processing, and extended support hours - all designed to empower you to focus on what matters most - like reaching your goals.</p>
                </div>
            </div>
            <div class="row g-4">
                        ...
                        <div class="row g-0" data-cues="slideInUp" data-duration="900">
                            <div class="col-md-6">
                                <div class="work-single-item">
                                    ...
                                    <p class="text_limit">Our team is ready to help you understand and make the most of your plan.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="work-single-item">
                                    <div class="d-flex align-items-center mb-30">
                                        ...
                                        <div class="">
                                            <h3>Extended support for your needs:</h3>
                                        </div>
                                    </div>
                                    <p class="text_limit">With long-term support and extended opening hours, our team is here for you when you need us.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="work-single-item">
                                    <div class="d-flex align-items-center mb-30">
                                        ...
                                        <div class="">
                                            <h3>Innovative Nappa Portal:</h3>
                                        </div>
                                    </div>
                                    <p class="text_limit">Gain real-time access to your budget with Nappa, our user-friendly online portal that simplifies the management of your NDIS plan.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="work-single-item">
                                    <div class="d-flex align-items-center mb-30">
                                        ...
                                        <div class="">
                                            <h3>Reliable and Prompt service:</h3>
                                        </div>
                                    </div>
                                    <p class="text_limit">We ensure that your invoices are processed quickly to maintain consistent service delivery from your providers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row gy-2" data-cues="slideInUp" data-duration="900">
            <div class="col-lg-12 text-center">
                ...
                <p class="mb-5">Some people think plan managers just pay invoices. Not us. We work to maximise the benefits of your NDIS plan so you can live your best life.</p>
            </div>
        </div>
        ...
        <div class="row g-4" data-cues="slideInUp" data-duration="900">
            ...
            <!-- Card 1 -->
            <div class="col-xl-4">
                <a href="#" class="services-single-item style-two border d-block text-decoration-none">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        ...
                        <h3 class="mb-0">Provider Management</h3>
                    </div>
                    <p>Let us do the juggling. We can work directly with all your NDIS providers to ensure payments and invoice processing are seamless. Our online portal and mobile app make it easy to keep track of your budget.</p>
                </a>
            </div>
 <!-- Card 3 -->
            <div class="col-xl-4">
                <a href="#" class="services-single-item style-two border d-block text-decoration-none">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        ...
                        <h3 class="mb-0">Invoice Processing</h3>
                    </div>
                    <p>Let's be frank. Paying invoices probably isn't your idea of fun, but the good news is we love it. My Plan Manager receives invoices from your providers and pays them directly on your behalf. It's fast, easy, and best of all, you don't have to do it.</p>
                </a>
            </div>
                <!-- Card 5 -->
            <div class="col-xl-4">
                <div class="services-single-item style-two border d-block">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        <div class="icon rounded-circle d-flex align-items-center justify-content-center">
                            <img src="assets/images/icon/service5.png" alt="service">
                        </div>
                        <h3 class="mb-0">Claim Lodgement</h3>
                    </div>
                    <p>If logging into the Government's NDIS portal doesn't fill you with joy, help is at hand. My Plan Manager lodges your claims for you so you can spend your time doing something that makes you feel good instead.</p>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-xl-4">
                <a href="#" class="services-single-item style-two border d-block text-decoration-none">
                    ...
                    <p>Get the most out of your NDIS budget. We are here to help you manage your spending and make sure you are getting the best possible value. Don't risk under or overspending. Our experts are here to support and guide you.</p>
                </a>
            </div>
            ...
            <div class="col-xl-4">
                <div class="services-single-item style-two border d-block">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        ...
                        <h3 class="mb-0">Your Choice of Providers</h3>
                    </div>
                    <p>If you are currently NDIS agency managed, you are restricted to using only NDIS registered providers. We give you the choice of any provider, so you can choose the best care and services for you and your budget.</p>
                </div>
            </div>
            ...
            <div class="col-xl-4">
                <a href="#" class="services-single-item style-two border d-block text-decoration-none">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        ...
                        <h3 class="mb-0">It Costs You Nothing</h3>
                    </div>
                    <p>Plan management fees do not come out of your support budget. They are calculated in addition to your care needs and paid for separately by the NDIS. This means that there is no out of pocket cost to you.</p>
                </a>
            </div>
