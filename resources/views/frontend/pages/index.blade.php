    ...
    {{-- <div class="CONTINUITY CARE-information-area bg-img  cta-section"
        ...
        <div class="container mw-1685">
            <div class="row align-items-center g-4" data-cues="slideInUp" data-duration="900">
                <div class="col-lg-8">
                    <div class="d-flex flex-wrap align-items-center CONTINUITY CARE-information-content">
                        <div class="flex-shrink-0">
                ...
                <div class="col-lg-4">
                    <div class="d-flex flex-wrap CONTINUITY CARE-information-content justify-content-lg-end">
